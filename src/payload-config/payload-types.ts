...
export interface Consultation {
  id: number;
  /**
   * Le text qui va s'afficher dans l'URL
   */
  slug: string;
  domaine: string;
  titre: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "auxiliaires".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "auxiliaires_select".
 */
export interface AuxiliairesSelect<T extends boolean = true> {
  slug?: T;
  domaine?: T;
  titre?: T;
  introduction?: T;
