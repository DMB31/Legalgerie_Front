      ...
      <section className="relative bg-black text-white py-24 md:py-32">
        ...
        <div className="w-full max-w-[1100px] mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <p className="text-sm text-gray-300 mb-4">Avocat</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Un <span className="text-primary">allié</span> pour défendre vos droits 
            </h1>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
            L’avocat est un professionnel du droit qui accompagne, conseille et défend les personnes dans leurs démarches juridiques et judiciaires. Il intervient pour aider à mieux comprendre la loi, préparer des documents ou représenter ses clients devant les tribunaux.            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
            Au-delà de ses compétences techniques, l’avocat est aussi un soutien humain, engagé à protéger les droits et à faire valoir les intérêts de ceux qui le consultent.            </p>
    ...
    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-[73px] max-w-[1035px] mx-auto">
      ...
      <div className="w-full md:w-[565px] flex-shrink-0">
        ...
        <div className="mb-[42px]">
          ...
          Les situations suivantes nécessitent souvent l’intervention d’un avocat :          </p>
        </div>
          ...
          {/* Garde à vue et enquête */}
           ...
           <div className="flex gap-4">
            ...
            <div>
              ...
              Plaider devant les juridictions.             </h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Donner des conseils juridiques personnalisés.              </h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Assister lors de négociations.              </h3>
            </div>
          </div>
