      ...
      <section className="relative bg-black text-white py-24 md:py-32">
        ...
        <div className="w-full max-w-[1100px] mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <p className="text-sm text-gray-300 mb-4">Traducteur-interprète officiel</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Un pont entre les langues et la justice 
            </h1>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
            Le traducteur – interprète officiel est un professionnel indispensable pour garantir la compréhension et le respect des droits des personnes ne maîtrisant pas la langue de la procédure. Son rôle est de traduire fidèlement, à l’écrit comme à l’oral, les documents et échanges nécessaires devant les administrations et tribunaux.            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
            Grâce à sa compétence linguistique et juridique, il assure une communication claire et fiable, permettant à chacun de faire valoir ses droits dans un cadre équitable.            </p>
      ...
      <div className="w-full md:w-[565px] flex-shrink-0">
        ...
        <div className="mb-[42px]">
          <h2 className="text-[40px] font-semibold leading-[110%] mb-6">
            Quelles sont les fonctions d'un <span className="text-primary">eTraducteur-interprète ?</span> ?
          </h2>
          <p className="text-base font-normal leading-5">
          Les situations suivantes nécessitent souvent l’intervention d’un Traducteur-interprète :          </p>
        </div>
        ...
        <div className="flex flex-col gap-[29px]">
          {/* Garde à vue et enquête */}
           ...
           <div className="flex gap-4">
            ...
            <div>
              ...
              Traduire des documents administratifs et juridiques (jugements, contrats, actes notariés).            </h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Assurer l’interprétation lors d’audiences judiciaires, enquêtes ou auditions.             </h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Faciliter la communication entre magistrats, avocats, policiers et justiciables.             </h3>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Garantir l’authenticité et la précision des traductions certifiées.             </h3>
            </div>
          </div>
