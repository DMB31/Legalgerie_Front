      ...
      <section className="relative bg-black text-white py-24 md:py-32">
        ...
        <div className="w-full max-w-[1100px] mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <p className="text-sm text-gray-300 mb-4">Huissier de justice </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Un  spécialite au <span className="text-primary">service de la vérité</span> 
            </h1>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
            L’huissier de justice est un professionnel du droit chargé d’exécuter les décisions de justice et de constater officiellement des faits. Son rôle est essentiel pour garantir le respect des jugements et assurer une preuve incontestable dans de nombreuses situations.            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
            En plus de son rôle d’exécution, l’huissier accompagne particuliers et entreprises dans la prévention et la résolution des litiges grâce à son expertise juridique            </p>
      ...
      <div className="w-full md:w-[565px] flex-shrink-0">
        ...
        <div className="mb-[42px]">
          <h2 className="text-[40px] font-semibold leading-[110%] mb-6">
            Quelles sont les fonctions d'un <span className="text-primary">huissier de justice</span> ?
          </h2>
          <p className="text-base font-normal leading-5">
          Les situations suivantes nécessitent souvent l’intervention d’un huissier de justice :          </p>
        </div>
        ...
        <div className="flex flex-col gap-[29px]">
          {/* Garde à vue et enquête */}
           ...
           <div className="flex gap-4">
            ...
            <div>
              ...
              Exécuter les décisions de justice (saisies, expulsions, recouvrements).             </h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Constater officiellement des faits (constats d’état des lieux, constats d’huissier, nuisance, etc.).</h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Signifier des actes de justice (assignations, convocations, jugements).            </h3>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Accompagner les procédures de recouvrement amiable et judiciaire.            </h3>
            </div>
          </div>
