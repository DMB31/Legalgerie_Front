      ...
      <section className="relative bg-black text-white py-24 md:py-32">
        ...
        <div className="w-full max-w-[1100px] mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <p className="text-sm text-gray-300 mb-4">Juriste</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Un<span className="text-primary">conseiller juridique</span> au coeur des entreprises et institutions 
            </h1>
            <p className="text-lg text-gray-300 mb-4 leading-relaxed">
            Le juriste est un professionnel du droit qui intervient au sein des entreprises, administrations ou associations pour sécuriser leurs décisions et garantir la conformité de leurs actions avec la législation.            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
            Il analyse les textes de loi, rédige des documents contractuels et accompagne la direction dans la gestion des risques juridiques.            </p>

            <p className="text-lg text-gray-300 leading-relaxed">
            Grâce à sa veille constante sur l’évolution du droit, le juriste contribue à prévenir les litiges et à défendre les intérêts de l’organisation qu’il représente.            </p>
      ...
      <div className="w-full md:w-[565px] flex-shrink-0">
        ...
        <div className="mb-[42px]">
          <h2 className="text-[40px] font-semibold leading-[110%] mb-6">
            Quelles sont les fonctions d'un <span className="text-primary">juriste ?</span> ?
          </h2>
          <p className="text-base font-normal leading-5">
          Les situations suivantes nécessitent souvent l’intervention d’un juriste :          </p>
        </div>
        ...
        <div className="flex flex-col gap-[29px]">
          {/* Garde à vue et enquête */}
           ...
           <div className="flex gap-4">
            ...
            <div>
              ...
              Rédiger et vérifier les contrats (travail, partenariats, commerciaux, etc.).             </h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Conseiller la direction sur les aspects légaux et réglementaires des décisions.</h3>
            </div>
          </div>
           ...
           <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Prévenir les litiges en assurant la conformité des activités à la loi.            </h3>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold leading-[26px] mb-2">
              Représenter l’entreprise dans les négociations et contentieux.            </h3>
            </div>
          </div>
